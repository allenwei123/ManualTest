...
define("Element", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.Element;
    };
}(this)));
...
define('EventEmitter', ['EventEmitter/EventEmitter'], function (main) { return main; });
